...
<div class="users-page-wrapper">
    ...
    <div class="users-stats">
        <div class="stat-card stat-active">
            ...
            <span>{{ $users->where('account_status', 'Active')->count() }} Active</span>
        </div>
        <div class="stat-card stat-inactive">
            <div class="stat-icon">
                <i class="fas fa-times-circle"></i>
            </div>
            <span>{{ $users->where('account_status', 'Inactive')->count() }} Inactive</span>
        </div>
        ...
        <div class="table-container">
            <table class="users-table table">
                ...
                <tbody id="usersTableBody">
                    ...
                    <tr data-user-name="{{ strtolower($user->name) }}" data-user-role="{{ strtolower($user->account_category) }}">
                        <td>{{ $index + 1 }}</td>
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=2563eb&color=fff&size=40" 
                        ...
                        <td>
                            @switch($user->role)
                                @case('admin') <span class="badge bg-danger"><i class="fas fa-crown"></i> Admin</span> @break
                                @case('evacuation_admin') <span class="badge bg-primary"><i class="fas fa-building-shelter"></i> Evacuation Admin</span> @break
                                @case('barangay_admin') <span class="badge bg-success"><i class="fas fa-map-marker-alt"></i> Barangay Admin</span> @break
                            @endswitch
                        </td>
                        ...
                        <td>
                            <div class="action-buttons">
                               <a href="#" class="btn btn-warning btn-sm btn-table edit-user-btn" 
                                ...
                                data-category="{{ $user->account_category }}"
