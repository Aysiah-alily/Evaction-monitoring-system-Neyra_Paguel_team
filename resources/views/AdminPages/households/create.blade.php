    ...
    <div class="d-flex">
        ...
        <div class="main-content flex-grow-1">
            <div class="container-fluid">
                <h1 class="h3 text-dark mb-4"><i class="fas fa-plus me-2"></i>Add New Household</h1>
                ...
                <div class="form-container">
                    <form method="POST" action="{{ route('households.store') }}" class="row g-3">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('household_name') is-invalid @enderror" 
                                   ...
                                   value="{{ old('household_name') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('head_of_family') is-invalid @enderror" 
                                   ...
                                   value="{{ old('head_of_family') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" 
                                ...
                                <option value="Evacuated" {{ old('status') == 'Evacuated' ? 'selected' : '' }}>Evacuated</option>
                                ...
                                <option value="Not Evacuated" {{ old('status') == 'Not Evacuated' ? 'selected' : '' }}>Not Evacuated</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('date_registered') is-invalid @enderror" 
                                   ...
                                   value="{{ old('date_registered', date('Y-m-d')) }}" required>
