...
@section('title', 'Dashboard - Evacuation Management')
    ...
    <div class="dashboard-metrics">
        <div class="card metric-card metric-primary">
            <div class="metric-content">
                ...
                <div class="metric-number">{{ $totalUsers ?? 1,247 }}</div>
            </div>
        ...
        <div class="card metric-card metric-success">
            <div class="metric-content">
                ...
                <div class="metric-number">{{ $totalCenters ?? 23 }}</div>
            </div>
        ...
        <div class="card metric-card metric-primary">
            <div class="metric-content">
                ...
                <div class="metric-number">{{ $totalHouseholds ?? 5,892 }}</div>
            </div>
        ...
        <div class="card metric-card metric-danger">
            <div class="metric-content">
                ...
                <div class="metric-number">{{ $totalEvacuated ?? 2,847 }}</div>
            </div>
        ...
        <div class="card metric-card metric-warning">
            <div class="metric-content">
                ...
                <div class="metric-number">{{ $notEvacuated ?? 1,234 }}</div>
            </div>
        ...
        <div class="card metric-card metric-warning">
            <div class="metric-content">
                ...
                <div class="metric-number">{{ $partialEvacuated ?? 456 }}</div>
            </div>
...
(function() {
    ...
    function initDashboard() {
        ...
        const chartData = {
            evacuated: {{ $totalEvacuated ?? 2847 }},
            notEvacuated: {{ $notEvacuated ?? 1234 }},
            partial: {{ $partialEvacuated ?? 456 }},
