...
<head>
    ...
    <title>@yield('title', 'Evacuation Monitoring System')</title>
        ...
        <nav x-data="{ open: false }">
            ...
            <div class="logo-container">
                @if(file_exists(public_path('images/mdrrmo-logo.png')))
                    <img src="{{ asset('images/mdrrmo-logo.png') }}" alt="MDRRMO Logo" class="logo-img">
                @elseif(file_exists(public_path('images/logo.png')))
                    <img src="{{ asset('images/logo.png') }}" alt="MDRRMO Logo" class="logo-img">
                @else
                    <!-- Fallback SVG Logo -->
            ...
            <div class="nav-links">
                ...
                <a href="{{ route('welcome') }}" class="nav-link {{ request()->routeIs('welcome') ? 'active' : '' }}">Landing</a>
                <a href="{{ route('home') }}" class="nav-link {{ request()->routeIs('home') ? 'active' : '' }}">Home</a>
                <a href="{{ route('news') }}" class="nav-link {{ request()->routeIs('news') ? 'active' : '' }}">News</a>
                <a href="{{ route('alerts') }}" class="nav-link {{ request()->routeIs('alerts') ? 'active' : '' }}">Alerts</a>
                <a href="{{ route('firstaid') }}" class="nav-link {{ request()->routeIs('firstaid') ? 'active' : '' }}">First Aid</a>
