            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="addQuickAccess">
                        ...
                        <li>
                            <a href="{{ url('/puroks') }}" class="dropdown-item">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="displayQuickAccess">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('households.index', ['purok' => '']) }}">
    ...
    <div class="table-card">
         <div class="table-header d-flex justify-content-between align-items-center">
            <h3 class="table-title">
                ...
                Households List
                <span class="badge bg-primary ms-2">{{ $households->total() ?? 0 }} Total</span>
            </h3>
        </div>
        ...
        <div class="table-container">
            <table class="table-custom table-hover">
                ...
                <tbody>
                    @include('BarangayPages.partials.household_rows')
                </tbody>
            </table>
        </div>
        ...
        @if($households instanceof \Illuminate\Pagination\Paginator)
            <div class="p-4 border-top" style="border-color: var(--gray-200);">
                {{ $households->links('pagination::bootstrap-4') }}
            </div>
        @endif
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    const filterForm = document.querySelector('form[action="{{ route('households.index') }}"]');
...
function bulkEdit() {
    ...
    if (confirm(`Edit ${checkedCount} selected household(s)?`)) {
        ...
        form.method = 'GET';
        form.action = '{{ route("households.bulk-edit") }}';
...
function bulkAddMembers() {
    ...
    if (confirm(`Add members to ${checkedCount} selected household(s)?`)) {
        const form = document.createElement('form');
        form.method = 'GET';
        form.action = '{{ route("households.members.bulk-create") }}';
...
function bulkDelete() {
    ...
    if (confirm(`Delete ${checkedCount} household(s)? This cannot be undone!`)) {
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = '{{ route("households.bulk-destroy") }}';
