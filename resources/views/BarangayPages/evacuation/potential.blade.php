...
@section('title', 'Potential Evacuees')
...
<div class="main-content">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-content">
                ...
                <h1 class="stat-number">{{ count($highPriority ?? []) }}</h1>
            </div>
    ...
    <div class="nav-pills-modern">
         <a href="{{ route('evacuation.list') }}" class="nav-link">
        ...
        <a href="{{ route('evacuation.potential') }}" class="nav-link active">
    ...
    <div class="table-card">
        <div class="table-card-header d-flex justify-content-between align-items-center">
            <div>
                ...
                <small class="text-muted">{{ count($potentialEvacuees ?? []) }} pending review</small>
            </div>
