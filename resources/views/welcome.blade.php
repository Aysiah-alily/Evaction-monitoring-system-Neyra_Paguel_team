                ...
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    ...
                    <div style="position: relative; width: 50px; height: 50px; flex-shrink: 0;">
                        @if(file_exists(public_path('images/mdrrmo-logo.png')))
                            <img src="{{ asset('images/mdrrmo-logo.png') }}" alt="MDRRMO Camalaniugan Logo" style="width: 100%; height: 100%; object-fit: contain;">
                        @elseif(file_exists(public_path('images/logo.png')))
                            <img src="{{ asset('images/logo.png') }}" alt="MDRRMO Camalaniugan Logo" style="width: 100%; height: 100%; object-fit: contain;">
                        @else
        ...
        <div class="modal-overlay" id="roleModal">
            <div class="modal-card">
                ...
                <div class="role-buttons">
                    ...
                    <a href="{{ route('login.evacuation') }}" class="role-btn">
                    ...
                    <a href="{{ route('login.barangay') }}" class="role-btn">
                    ...
                    <a href="{{ route('home') }}" class="role-btn">
