            ...
            <div class="stat-card gradient-primary">
                <div class="stat-card-inner p-4">
                    ...
                    <div class="stat-content">
                        <div class="stat-number fs-1 fw-bold">{{ $submissions->count() }}</div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="stat-card gradient-success">
                <div class="stat-card-inner p-4">
                    ...
                    <div class="stat-content">
                        <div class="stat-number fs-1 fw-bold">{{ $submissions->where('status', 'completed')->count() }}</div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="stat-card gradient-warning">
                <div class="stat-card-inner p-4">
                    ...
                    <div class="stat-content">
                        <div class="stat-number fs-1 fw-bold">{{ $submissions->where('status', 'pending')->count() }}</div>
                ...
                <div class="table-responsive flex-grow-1">
                    @if($submissions->isEmpty())
                        ...
                        <div class="empty-state">
                            <div class="text-center">
                                ...
                                <a href="{{ route('EvacAdmin.DAFACForm') }}" class="btn btn-primary btn-lg px-4">
                    ...
                    @else
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @foreach($submissions->take(10) as $index => $submission)
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fw-bold">{{ $submission->surname }}, {{ $submission->firstname }}</div>
                                                    <small class="text-muted">{{ $submission->contact_number ?? 'No contact' }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-light text-dark px-3 py-2 fw-semibold small">
                                                {{ \Carbon\Carbon::parse($submission->date_registered)->format('M d, Y') }}
                                            </span>
                                        </td>
                                        <td>
                                            @if(isset($submission->status))
                                                @php $status = $submission->status @endphp
                                                @switch($status)
                                                    @case('completed')
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <button class="btn btn-outline-primary view-form" data-id="{{ $submission->id }}" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-outline-success edit-form" data-id="{{ $submission->id }}" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button class="btn btn-outline-danger remove-form" data-id="{{ $submission->id }}" title="Delete">
                            ...
                            <div class="card-footer bg-light border-0 p-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    <small class="text-muted">
                                        ...
                                        Showing 10 of {{ $submissions->count() }} forms
                                    </small>
