...
<div class="container-fluid py-4">
    <div class="card shadow-sm border-0">
        <div class="card-body">
           <form action="{{ route('EvacAdmin.store') }}" method="POST" id="evacForm">
    @csrf
                ...
                <div id="page1">
                    <div class="text-center mb-4 pb-3 border-bottom">
                        ...
                        <p class="text-muted small mb-0">Official Document No. {{ strtoupper(substr(str_shuffle('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'), 0, 8) ?: 'DOC' . rand(100000, 999999)) }}</p>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('region_id') is-invalid @enderror" name="region_id" id="region_id" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('province_id') is-invalid @enderror" name="province_id" id="province_id" required>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('city_muni_id') is-invalid @enderror" name="city_muni_id" id="city_muni_id" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('barangay_id') is-invalid @enderror" name="barangay_id" id="barangay_id" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror"
                                   name="date_of_birth" value="{{ old('date_of_birth') }}" id="date_of_birth" required>
                            @error('date_of_birth')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
