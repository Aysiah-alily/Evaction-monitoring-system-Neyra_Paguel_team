<nav x-data="{ open: false }"      class="bg-white border-b border-gray-200 shadow-xl sticky top-0 z-50">
...
</nav><?php /**PATH C:\xampp\htdocs\Prototype_compy - Copy - Copy\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>