<?php $__env->startSection('title', 'Disaster Tracking - MDRRMO Camalaniugan'); ?>
...
<div class="section">
    ...
    <div style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%);
        ...
        <small style="opacity: 0.8;"><?php echo e(now()->format('M j, Y, g:i A')); ?></small>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Prototype_compy - Copy - Copy\resources\views/UserPages/home.blade.php ENDPATH**/ ?>