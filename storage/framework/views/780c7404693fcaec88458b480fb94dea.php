...
<?php $__env->startSection('title', 'Dashboard - Barangay Evacuation Management'); ?>

<?php $__env->startSection('topbar'); ?>
    <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e(Auth::user()->name ?? 'Admin'); ?></span>
                <img class="img-profile rounded-circle" src="https://ui-avatars.com/api/?name=<?php echo e(Auth::user()->name ?? 'Admin'); ?>&background=4e73df&color=fff" style="width:35px;height:35px;">
            </a>
        </li>
    </ul>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="kpi-item kpi-primary">
                                ...
                                <div class="kpi-top d-flex align-items-center justify-content-center mb-4">
                                    ...
                                    <div class="kpi-number text-primary"><?php echo e($totalHouseholds); ?></div>
                                </div>
                                <!-- Label BELOW -->
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="kpi-item kpi-success">
                                <div class="kpi-top d-flex align-items-center justify-content-center mb-4">
                                    ...
                                    <div class="kpi-number text-success"><?php echo e($totalPuroks); ?></div>
                                </div>
                                <div class="text-center">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="kpi-item kpi-warning">
                                <div class="kpi-top d-flex align-items-center justify-content-center mb-4">
                                    ...
                                    <div class="kpi-number text-warning"><?php echo e($totalEvacuees); ?></div>
                                </div>
                                <div class="text-center">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="kpi-item kpi-danger">
                                <div class="kpi-top d-flex align-items-center justify-content-center mb-4">
                                    ...
                                    <div class="kpi-number text-danger"><?php echo e($highRiskCount); ?></div>
                                </div>
                                <div class="text-center">
            ...
            <div class="card user-card custom-card-style">
                <div class="card-body text-center p-5">
                    <div class="mb-4 greeting-section">
                        ...
                        <span class="badge custom-badge-style"><?php echo e(ucfirst(Auth::user()->role ?? 'Admin')); ?></span>
                    </div>
                    <div class="patient-count-section">
                        <div class="circular-progress-container">
                            <div class="circular-progress" style="--progress: <?php echo e($totalHouseholds / 1000); ?>;"> <!-- Assuming a max of 1000 for example, adjust as needed -->
                                <div class="progress-value">
                                    <div class="h3 font-weight-bold"><?php echo e($totalHouseholds); ?></div>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="p-3 border-bottom" style="background: var(--gray-50);">
                        <div class="d-flex flex-nowrap overflow-auto mb-3" style="gap: 6px;">
                            <?php $__currentLoopData = $purokDistribution['labels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="purok-filter flex-fill px-3 py-2"
                                     style="min-width: 120px; max-width: 130px;"
                                     data-purok="<?php echo e($label); ?>"
                                     onclick="filterByPurok('<?php echo e($label); ?>', this)">
                                    <small class="d-block"><?php echo e($label); ?></small>
                                    <small class="font-weight-bold"><?php echo e($purokDistribution['data'][$index]); ?></small>
                                </div>
                   ...
                   <!-- Table -->
                    <div class="table-container p-4" style="max-height: 400px;">
                        <table class="table table-hover mb-0" id="dataTable">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $recentHouseholds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $household): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-purok="Purok <?php echo e($household->purok); ?>"
                                        data-search="<?php echo e(strtolower($household->household_name . ' ' . ($household->address ?? '') . ' ' . $household->purok . ' ' . $household->priority_status . ' ' . $household->status)); ?>">
                                        <td><?php echo e($household->created_at->format('M d, Y')); ?></td>
                                        <td class="fw-semibold"><?php echo e(Str::limit($household->household_name, 18)); ?></td>
                                        <td class="text-muted small"> <?php echo e($household->barangay_name ?? ''); ?> <?php echo e($household->street_name ?? ''); ?> <?php echo e($household->house_number ?? ''); ?></td>
                                        <td>
                                            <span class="badge bg-info text-dark px-2 py-1 fs-sm fw-semibold">P<?php echo e($household->purok); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($household->priority_status == 'High' ? 'bg-danger' : 'bg-warning text-dark'); ?> px-2 py-1 fs-sm fw-semibold">
                                                <?php echo e($household->priority_status); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($household->status == 'Active' ? 'bg-success' : ($household->status == 'Inactive' ? 'bg-secondary' : 'bg-info')); ?> px-2 py-1 fs-sm">
                                                <?php echo e(ucfirst($household->status)); ?>
            ...
            <div class="card high-risk-section" style="width: 340px;">
                <div class="card-header py-3 px-3" style="background: #f8fafc; border-bottom: 1px solid #e5e7eb;">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-warning text-dark px-3 py-1 fw-bold"><?php echo e($highRiskCount); ?></span>
                    </div>
                </div>
                <div class="card-body p-3" style="height: calc(100% - 70px); overflow-y: auto;">
                    <?php $__empty_1 = true; $__currentLoopData = $potentialEvacueesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="household-list-item py-2 px-0 mb-1" data-household-id="<?php echo e($item->id); ?>">
                            <div class="d-flex justify-content-between align-items-center">
                                <!-- Household Info - Left Side -->
                                <div class="d-flex align-items-center flex-grow-1">
                                    <div class="household-avatar me-2">
                                        <div class="avatar-circle bg-light border">
                                            <img src="https://ui-avatars.com/api/?name=<?php echo e($item->household_name); ?>&background=4f46e5&color=fff"
                                                class="rounded-circle" style="width: 36px; height: 36px; object-fit: cover;">
                                        </div>
                                    </div>
                                    <div class="household-info">
                                        <div class="household-name fw-semibold text-gray-800 mb-0"><?php echo e(Str::limit($item->household_name, 20)); ?></div>
                                        <div class="household-purok text-muted fs-6 mt-npx1">Purok <?php echo e($item->purok); ?></div>
                                    </div>
                                </div>
                                
                                <!-- Priority & Actions - Right Side -->
                                <div class="d-flex align-items-center gap-2">
                                    <span class="priority-badge bg-warning text-dark px-2 py-px1 fs-sm fw-semibold"><?php echo e($item->priority_status); ?></span>
                                    <!-- Clean Dropdown -->
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" style="min-width: 140px;">
                                            <li><a class="dropdown-item py-2 px-3" href="<?php echo e(route('households.show', $item->id)); ?>"><i class="fas fa-eye me-2 text-primary"></i>View</a></li>
                                            <li><a class="dropdown-item py-2 px-3" href="<?php echo e(route('households.edit', $item->id)); ?>"><i class="fas fa-edit me-2 text-warning"></i>Edit</a></li>
                                            <li><hr class="dropdown-divider mx-3 my-1"></li>
                                            <li><button class="dropdown-item py-2 px-3 text-danger w-100 text-start" onclick="confirmDelete(<?php echo e($item->id); ?>, '<?php echo e($item->household_name); ?>')"><i class="fas fa-trash me-2"></i>Delete</button></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminbarangay', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proto\Prototype_compy - Copy - Copy\resources\views/BarangayPages/BarangayAdmin.blade.php ENDPATH**/ ?>