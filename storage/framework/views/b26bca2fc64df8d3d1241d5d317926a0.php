...
<body class="font-sans antialiased">
    <div class="top-bar">
        ...
        <div class="top-bar-right">
            ...
            <div class="user-profile" onclick="toggleUserDropdown()" id="userProfile">
                ...
                <div class="user-info">
                    <h5 id="userName"><?php echo e(auth()->user()->name ?? 'John Doe'); ?></h5>
                    <p id="userRole"><?php echo e(auth()->user()->role ?? 'Administrator'); ?></p>
                </div>
            ...
            <div class="dropdown-menu" id="userDropdown">
                ...
                <form id="logoutForm" method="POST" action="<?php echo e(route('logout')); ?>" style="display: inline;">
                    <?php echo csrf_field(); ?>
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('EvacAdmin.dashboard')); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('EvacAdmin.Registration')); ?>">
                            <span class="nav-link-icon">
                                <svg viewBox="0 0 24 24">
                    ...
                    <li class="nav-item" x-data="{ open: false }">
                        ...
                        <ul class="submenu" x-show="open" x-cloak x-transition>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('EvacAdmin.monitor-progress')); ?>">
                                    <span class="nav-link-icon">
                                        <svg viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('EvacAdmin.evacuation-tracking')); ?>">
                                    <span class="nav-link-icon">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let userRole = '<?php echo e(auth()->user()->role ?? "Administrator"); ?>';
...
</html><?php /**PATH C:\xampp\htdocs\proto\Prototype_compy - Copy - Copy\resources\views/layouts/app.blade.php ENDPATH**/ ?>