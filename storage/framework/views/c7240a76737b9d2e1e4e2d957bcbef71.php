                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-gray-800"><?php echo e($barangayCounts->sum('total')); ?></div>
                        </div>
                        <div class="col-auto">
...
<div id="household-toggle-content" class="mb-3">
    <div class="table-responsive p-2" style="background-color: #fff; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        <table class="table table-sm table-bordered h-10 text-center mb-0">
            ...
            <tbody>
                <?php $__currentLoopData = $barangayCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barangay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    ?>
                    <tr>
                        <td><?php echo e($barangay->barangay); ?></td>
                        <td><?php echo e($evacuatedHouseholds); ?></td>
                        <td><?php echo e($notEvacuatedHouseholds); ?></td>
                        <td><?php echo e($totalHouseholds); ?></td>
                    </tr>
...
<script>
<?php if(!$barangayCounts->isEmpty()): ?>
const ctx = document.getElementById('barangayChart').getContext('2d');

const labels = <?php echo json_encode($barangayCounts->pluck('barangay')); ?>;
const data = <?php echo json_encode($barangayCounts->pluck('total')); ?>;
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-0" id="evacueeTable">
                               ...
                               <th>#</th>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $evacuees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $evacuee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($index + 1); ?></td>
                                            <td><?php echo e($evacuee->last_name); ?>, <?php echo e($evacuee->first_name); ?></td>
                                            <td><?php echo e($evacuee->barangay ?? 'N/A'); ?></td>
                                            <td>
                                                <?php if($evacuee->is_evacuated): ?>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-danger btn-sm remove-row" data-id="<?php echo e($evacuee->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Prototype_compy - Copy - Copy\resources\views/EvacPages/monitor-progress.blade.php ENDPATH**/ ?>