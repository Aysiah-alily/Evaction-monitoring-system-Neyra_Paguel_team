...
<?php $__env->startSection('header'); ?>
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        <?php echo e(__('Barangay Information')); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">
                        ...
                        <?php echo e(isset($barangay) ? 'Edit Barangay' : 'Add New Barangay'); ?>

                    </h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?php echo e(isset($barangay) ? route('barangay.update', $barangay->id) : route('barangay.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <?php if(isset($barangay)): ?> <?php echo method_field('PUT'); ?> <?php endif; ?>
                        
                        <div class="form-row">
                            <div class="form-group">
                                <label for="barangay_name" class="form-label">Barangay Name <span style="color: var(--danger);">*</span></label>
                                <input type="text" class="form-control" id="barangay_name" name="barangay_name" placeholder="Enter barangay name" required value="<?php echo e(isset($barangay) ? $barangay->name : old('barangay_name')); ?>">
                            </div>
                            <div class="form-group">
                                <label for="district" class="form-label">District</label>
                                <input type="text" class="form-control" id="district" name="district" placeholder="Enter district (optional)" value="<?php echo e(isset($barangay) ? $barangay->district : old('district')); ?>">
                            </div>
                            <div class="form-group">
                                <label for="population" class="form-label">Population <span style="color: var(--danger);">*</span></label>
                                <input type="number" class="form-control" id="population" name="population" placeholder="Enter population" min="0" required value="<?php echo e(isset($barangay) ? $barangay->population : old('population')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="btn-group" style="margin-top: 1rem;">
                            <?php if(isset($barangay)): ?>
                                ...
                                <a href="<?php echo e(route('barangay.index')); ?>" class="btn btn-secondary">
                ...
                <div class="card-header">
                    <h2 class="card-title">
                        ...
                        <span style="margin-left: auto; font-size: 0.85rem; font-weight: 500; color: var(--gray);">
                            Total: <?php echo e(count($barangays)); ?> barangays
                        </span>
                    </h2>
                </div>
                    ...
                    <?php if(count($barangays) > 0): ?>
                        <div class="table-container">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $barangays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <div style="display: flex; align-items: center; gap: 0.75rem;">
                                                    ...
                                                    <span style="font-weight: 600;"><?php echo e($row->name); ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if($row->district): ?>
                                            ...
                                            <td>
                                                <div style="display: flex; align-items: center; gap: 0.5rem;">
                                                    ...
                                                    <span style="font-weight: 600; color: var(--secondary);"><?php echo e(number_format($row->population)); ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="action-buttons" style="justify-content: center;">
                                                    <a href="<?php echo e(route('barangay.edit', $row->id)); ?>" class="action-btn edit">
                                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                                                        Edit
                                                    </a>
                                                    <form method="POST" action="<?php echo e(route('barangay.destroy', $row->id)); ?>" style="display: inline;">
                                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superlayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Prototype_compy - Copy - Copy\resources\views/AdminPages/barangay.blade.php ENDPATH**/ ?>