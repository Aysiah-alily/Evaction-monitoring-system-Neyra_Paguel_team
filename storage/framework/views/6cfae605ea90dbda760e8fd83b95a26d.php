...
<?php $__env->startSection('title', 'Evacuee Dashboard'); ?>
...
<div class="main-content">
    ...
    <div class="nav-pills-modern">
        <a href="<?php echo e(route('evacuation.list')); ?>" class="nav-link active">
    ...
    <div class="table-card">
        <div class="table-card-header d-flex justify-content-between align-items-center">
            <div>
                ...
                <small class="text-muted"><?php echo e($evacuees->count() ?? 0); ?> registered</small>
            </div>
        ...
        <?php if($evacuees->count() > 10): ?>
        <div class="p-4 bg-light border-top">
            <small class="text-muted">
                Showing <?php echo e($evacuees->count()); ?> of <?php echo e($evacueeCount ?? 0); ?> total evacuees
            </small>
        </div>
        <?php endif; ?>
    </div>
...
let evacuees = <?php echo json_encode($evacuees ?? [], 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminbarangay', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Prototype_compy - Copy - Copy\resources\views/BarangayPages/evacuation/list.blade.php ENDPATH**/ ?>